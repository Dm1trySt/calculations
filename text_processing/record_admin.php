<?php ## запись и фильтрация данных
    ...
    # Если пользователь ничего не введет в поле text потребует ввести текст
    if(mb_strlen($text) <= 0){
    ...
    if($secret_text != ""){
        ...
        # SQL-запрос в БД для запись секретного расчета и id текста
    ...
    header('Location: input_admin.html');
?>
